...
步骤二——风险评估：
按第~\ref{subsec:grading-rules}~节所述的七级判定规则对命令进行分级。
...
如图~\ref{fig:safety-blocked}~所示，当系统检测到危险命令或高风险操作时，
CLI界面会给出拦截提示或风险警告，并要求用户进一步确认。

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pic/safety-blocked}
